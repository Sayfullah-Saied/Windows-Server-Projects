...
Right-click the folder and select Properties → Sharing → Advanced Sharing → Permissions. Then add the group that belongs to that folder and remove any unnecessary permissions or groups.
