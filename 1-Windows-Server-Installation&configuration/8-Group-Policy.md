...
<h3>We will setup 2 user policy and 2 computer policy and we will change the background for users in the domain</h3>
...
4-Map Network Drive<br>

<h3>Configure and link policies to the domain</h3>
